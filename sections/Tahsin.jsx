...
import {SadmanStarter,TahsinAbedin, startingFeatures} from "../constants";
...
const Tahsin = (props) => (
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      >
        <TypingText title="| Head Of Engineering" />
        <TitleText title={<>Tahsin Abedin</>} />
        <div className="mt-[31px] flex flex-col max-w-[370px] gap-[24px]">
          {TahsinAbedin.map((feature, index) => (
