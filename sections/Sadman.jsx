...
import {SadmanStarter, startingFeatures} from "../constants";
...
const Sadman = (props) => (
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      >
        <TypingText title="| Chief Technology Officer" />
        <TitleText title={<>Sadman Sakib</>} />
        <div className="mt-[31px] flex flex-col max-w-[370px] gap-[24px]">
          {SadmanStarter.map((feature, index) => (
